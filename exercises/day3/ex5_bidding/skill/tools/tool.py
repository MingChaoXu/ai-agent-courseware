...
招标文件智能分析 Skill Tool
Usage:
    from tools.tool import ex5_bidding_analyze
    result = ex5_bidding_analyze("input text")
"""
...
def ex5_bidding_analyze(input_text: str) -> str:
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="招标文件智能分析 Skill Tool")
