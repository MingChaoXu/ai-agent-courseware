"""
Bidding Document Intelligent Analysis Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Bidding Document Intelligent Analysis",
    description="招标文件智能分析 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 招标文件智能分析")
