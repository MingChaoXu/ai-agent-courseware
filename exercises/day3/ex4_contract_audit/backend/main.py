"""
Contract Risk Intelligent Audit Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Contract Risk Intelligent Audit",
    description="合同风险智能审查 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 合同风险智能审查")
