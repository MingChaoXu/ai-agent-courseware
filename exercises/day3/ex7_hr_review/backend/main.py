"""
HR Policy Intelligent Review Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="HR Policy Intelligent Review",
    description="人事制度智能审查 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 人事制度智能审查")
