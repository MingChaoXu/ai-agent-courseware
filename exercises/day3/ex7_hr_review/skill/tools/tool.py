...
人事制度智能审查 Skill Tool
Usage:
    from tools.tool import ex7_hr_review_analyze
    result = ex7_hr_review_analyze("input text")
"""
...
def ex7_hr_review_analyze(input_text: str) -> str:
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="人事制度智能审查 Skill Tool")
