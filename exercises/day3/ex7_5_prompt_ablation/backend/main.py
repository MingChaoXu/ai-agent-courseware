"""
Prompt Ablation Experiment Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Prompt Ablation Experiment",
    description="Prompt消融实验 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: Prompt消融实验")
