"""
Prompt消融实验 Skill Tool
Usage:
    from tools.tool import ex7_5_prompt_ablation_chat
    answer = ex7_5_prompt_ablation_chat("question")
"""
...
def ex7_5_prompt_ablation_chat(question: str) -> str:
    """Ask the Prompt消融实验 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Prompt消融实验 Skill Tool")
