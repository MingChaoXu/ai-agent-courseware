...
施工文档智能生成 Skill Tool
Usage:
    from tools.tool import ex6_construction_doc_chat
    answer = ex6_construction_doc_chat("question")
"""
...
def ex6_construction_doc_chat(question: str) -> str:
    """Ask the 施工文档智能生成 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="施工文档智能生成 Skill Tool")
