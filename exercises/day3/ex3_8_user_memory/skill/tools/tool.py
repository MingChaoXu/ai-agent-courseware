"""
用户记忆管理Agent Skill Tool
Usage:
    from tools.tool import ex3_8_user_memory_chat
    answer = ex3_8_user_memory_chat("question")
"""
...
def ex3_8_user_memory_chat(question: str) -> str:
    """Ask the 用户记忆管理Agent agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="用户记忆管理Agent Skill Tool")
