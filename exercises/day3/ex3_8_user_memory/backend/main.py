"""
User Memory Management Agent Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="User Memory Management Agent",
    description="用户记忆管理Agent - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 用户记忆管理Agent")
