"""
事件驱动Agent实战 Skill Tool
Usage:
    from tools.tool import ex15_5_event_driven_chat
    answer = ex15_5_event_driven_chat("question")
"""
...
def ex15_5_event_driven_chat(question: str) -> str:
    """Ask the 事件驱动Agent实战 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="事件驱动Agent实战 Skill Tool")
