"""
Event-Driven Agent Practice Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Event-Driven Agent Practice",
    description="事件驱动Agent实战 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 事件驱动Agent实战")
