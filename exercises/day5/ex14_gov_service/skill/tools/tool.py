"""
政务服务全链路Agent Skill Tool
Usage:
    from tools.tool import ex14_gov_service_chat
    answer = ex14_gov_service_chat("question")
"""
...
def ex14_gov_service_chat(question: str) -> str:
    """Ask the 政务服务全链路Agent agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="政务服务全链路Agent Skill Tool")
