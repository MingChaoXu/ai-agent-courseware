"""
Government Service Full-Chain Agent Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Government Service Full-Chain Agent",
    description="政务服务全链路Agent - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 政务服务全链路Agent")
