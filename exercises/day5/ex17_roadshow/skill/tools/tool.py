"""
综合方案路演Agent Skill Tool
Usage:
    from tools.tool import ex17_roadshow_chat
    answer = ex17_roadshow_chat("question")
"""
...
def ex17_roadshow_chat(question: str) -> str:
    """Ask the 综合方案路演Agent agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="综合方案路演Agent Skill Tool")
