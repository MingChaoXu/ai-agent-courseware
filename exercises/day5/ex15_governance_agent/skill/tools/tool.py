"""
社会治理综合智能体 Skill Tool
Usage:
    from tools.tool import ex15_governance_agent_chat
    answer = ex15_governance_agent_chat("question")
"""
...
def ex15_governance_agent_chat(question: str) -> str:
    """Ask the 社会治理综合智能体 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="社会治理综合智能体 Skill Tool")
