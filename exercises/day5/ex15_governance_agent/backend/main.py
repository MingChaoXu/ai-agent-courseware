"""
Social Governance Multi-Agent Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Social Governance Multi-Agent",
    description="社会治理综合智能体 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 社会治理综合智能体")
