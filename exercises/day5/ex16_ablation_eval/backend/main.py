"""
Agent Ablation Evaluation Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Agent Ablation Evaluation",
    description="智能体消融评估 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 智能体消融评估")
