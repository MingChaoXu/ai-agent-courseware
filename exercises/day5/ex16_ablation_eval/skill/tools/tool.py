...
智能体消融评估 Skill Tool
Usage:
    from tools.tool import ex16_ablation_eval_chat
    answer = ex16_ablation_eval_chat("question")
"""
...
def ex16_ablation_eval_chat(question: str) -> str:
    """Ask the 智能体消融评估 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="智能体消融评估 Skill Tool")
