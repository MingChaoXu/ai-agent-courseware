"""
上下文压缩策略实验 Skill Tool
Usage:
    from tools.tool import ex3_5_context_compress_chat
    answer = ex3_5_context_compress_chat("question")
"""
...
def ex3_5_context_compress_chat(question: str) -> str:
    """Ask the 上下文压缩策略实验 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="上下文压缩策略实验 Skill Tool")
