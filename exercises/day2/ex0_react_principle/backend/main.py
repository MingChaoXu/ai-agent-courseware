"""
ReAct Reasoning Principle Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="ReAct Reasoning Principle",
    description="ReAct推理原理实验 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: ReAct推理原理实验")
