"""
ReAct推理原理实验 Skill Tool
Usage:
    from tools.tool import ex0_react_principle_chat
    answer = ex0_react_principle_chat("question")
"""
...
def ex0_react_principle_chat(question: str) -> str:
    """Ask the ReAct推理原理实验 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="ReAct推理原理实验 Skill Tool")
