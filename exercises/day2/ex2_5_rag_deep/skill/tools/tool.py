"""
RAG原理深入实验 Skill Tool
Usage:
    from tools.tool import ex2_5_rag_deep_chat
    answer = ex2_5_rag_deep_chat("question")
"""
...
def ex2_5_rag_deep_chat(question: str) -> str:
    """Ask the RAG原理深入实验 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="RAG原理深入实验 Skill Tool")
