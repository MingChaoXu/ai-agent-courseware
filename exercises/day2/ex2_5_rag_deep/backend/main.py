"""
RAG Principle Deep Dive Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="RAG Principle Deep Dive",
    description="RAG原理深入实验 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: RAG原理深入实验")
