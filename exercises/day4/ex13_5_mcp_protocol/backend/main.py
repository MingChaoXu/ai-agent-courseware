"""
MCP Protocol Demo Agent Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="MCP Protocol Demo Agent",
    description="MCP工具协议演示Agent - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: MCP工具协议演示Agent")
