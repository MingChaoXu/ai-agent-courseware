"""
Manufacturing BI Analysis Agent Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Manufacturing BI Analysis Agent",
    description="制造业BI分析Agent - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 制造业BI分析Agent")
