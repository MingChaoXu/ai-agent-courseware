"""
制造业BI分析Agent Skill Tool
Usage:
    from tools.tool import ex9_manufacturing_bi_chat
    answer = ex9_manufacturing_bi_chat("question")
"""
...
def ex9_manufacturing_bi_chat(question: str) -> str:
    """Ask the 制造业BI分析Agent agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="制造业BI分析Agent Skill Tool")
