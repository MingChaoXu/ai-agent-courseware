"""
PCB Quality Inspection Agent Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="PCB Quality Inspection Agent",
    description="PCB质量AI检测Agent - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: PCB质量AI检测Agent")
