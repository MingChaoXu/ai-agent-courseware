"""
PCB质量AI检测Agent Skill Tool
Usage:
    from tools.tool import ex12_quality_inspect_chat
    answer = ex12_quality_inspect_chat("question")
"""
...
def ex12_quality_inspect_chat(question: str) -> str:
    """Ask the PCB质量AI检测Agent agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="PCB质量AI检测Agent Skill Tool")
