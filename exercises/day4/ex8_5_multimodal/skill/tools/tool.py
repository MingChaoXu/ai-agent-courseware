"""
多模态处理三种模式对比 Skill Tool
Usage:
    from tools.tool import ex8_5_multimodal_chat
    answer = ex8_5_multimodal_chat("question")
"""
...
def ex8_5_multimodal_chat(question: str) -> str:
    """Ask the 多模态处理三种模式对比 agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="多模态处理三种模式对比 Skill Tool")
