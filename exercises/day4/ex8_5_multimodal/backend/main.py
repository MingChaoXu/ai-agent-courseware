"""
Multimodal Processing Mode Comparison Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Multimodal Processing Mode Comparison",
    description="多模态处理三种模式对比 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 多模态处理三种模式对比")
