"""
电力安全CV检测Agent Skill Tool
Usage:
    from tools.tool import ex13_cv_safety_chat
    answer = ex13_cv_safety_chat("question")
"""
...
def ex13_cv_safety_chat(question: str) -> str:
    """Ask the 电力安全CV检测Agent agent a question."""
    return get_tool().run(question)


if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="电力安全CV检测Agent Skill Tool")
