"""
Power Safety CV Inspection Agent Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Power Safety CV Inspection Agent",
    description="电力安全CV检测Agent - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 电力安全CV检测Agent")
