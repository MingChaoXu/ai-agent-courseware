"""
Precision Marketing RFM Analysis Backend - FastAPI Main Entry Point
"""
...
# ---- App Init ----
app = FastAPI(
    title="Precision Marketing RFM Analysis",
    description="精准营销RFM分析 - AI Agent Backend",
    version="1.0.0",
)
...
async def startup():
    ...
    chat.agent_instance = agent_instance
    print(f"[STARTUP] Agent initialized: 精准营销RFM分析")
